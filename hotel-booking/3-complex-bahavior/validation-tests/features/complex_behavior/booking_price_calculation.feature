Feature: Booking price calculation
  ...
  # Traceability: Booking.calculate_price(): float, and the ReservedRoom
  # association class (agreed_price, additional_charges) linking Booking and Room
  ...
  @complex-behavior @correctness @conformance @booking @pricing
