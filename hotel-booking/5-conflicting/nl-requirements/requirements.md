...
### People involved
The system keeps one uniform record for every person it deals with. For each of them it stores a unique identifying number, a first name, a family name, a phone number and an email address. An employee is a specialised kind of person and reuses exactly the same personal details. Guests who occupy the rooms are also tracked by the system.
...
### Rooms
Every room is identified by its room number. Along with that, the hotel records a free-text description of the room, and its standard nightly price.
### Bookings
